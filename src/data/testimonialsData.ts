...
export const testimonials: Testimonial[] = [
  {
    company: "/images/serene-living.jpg",
    ...
    author: {
      photo: "/images/photo_ethan.jpg",
      name: "Ethan Morgan",
      position: "Founder and CEO, Serene Living Products",
    },
  },
  {
    company: "/images/starlight-creations.jpg",
    ...
    author: {
      photo: "/images/photo_olivia.jpg",
      name: "Olivia Hayes",
      position: "Owner, Starlight Creations",
    },
  },
  {
    company: "/images/opulent-living-group.jpg",
    ...
    author: {
      photo: "/images/photo_alexander.jpg",
      name: "Alexander Reed",
